...
<div class="wp-block-query"><!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size"><?php esc_html_e('Must Visit Places:', 'eco-theme');?></h2>
<!-- /wp:heading -->
